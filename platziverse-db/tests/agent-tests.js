...
test.serial('Setup', t => {
  ...
  t.true(MetricStub.belongsTo.called, 'AgentModel.belongsTo was executed')
...
test.serial('Agent#findAll', async t => {
  ...
  t.true(AgentStub.findAll.calledWith(), 'findAll should be called with specified uuidArgs')
...
test.serial('Agent#createOrUpdate - exists', async t => {
  ...
  t.true(AgentStub.findOne.called, 'findOne should on model')
